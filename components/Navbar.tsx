...
export default function Navbar({ activeView, setActiveView, isSignedIn, onSignOut }) {
  ...
  const navItems = [
    ...
    { icon: <Gamepad2 />, label: "Game", view: "game" },
            ...
            <div className="flex items-center space-x-4">
              ...
              {isSignedIn ? (
                ...
                <div className="space-x-2">
                  <Button onClick={() => handleNavigation("signin")} variant="outline">
                    Sign In
                  </Button>
