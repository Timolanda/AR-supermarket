...
import { ShoppingCart, User, CuboidIcon as Cube, Search, Settings, Menu } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <span className="font-bold text-xl text-white cursor-pointer" onClick={() => handleNavigation('landing')}>AR Supermarket</span>
          </div>
          {isMobile ? (
            <div className="flex items-center">
              <button
